...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "Already_updated": MessageLookupByLibrary.simpleMessage(
            "Η μουσική Vibe είναι ήδη ενημερωμένη."),
        ...
        "DOWNLOAD": MessageLookupByLibrary.simpleMessage("Καταφόρτωση"),
        ...
        "New_Update_Available":
            MessageLookupByLibrary.simpleMessage("Διαθέσιμη νέα ενημέρωση"),
        ...
        "Request_a_feature":
            MessageLookupByLibrary.simpleMessage("Ζητήστε ένα χαρακτηριστικό"),
        "Right_to_left_direction": MessageLookupByLibrary.simpleMessage(
            "Ορισμός κατεύθυνσης κειμένου σε Δεξιά προς αριστερά"),
        "SOCIALS": MessageLookupByLibrary.simpleMessage("ΚΟΙΝΩΝΙΚΆ ΔΊΚΤΥΑ"),
        ...
        "Update": MessageLookupByLibrary.simpleMessage("Ενημερώνω"),
        ...
        "github_redirect": MessageLookupByLibrary.simpleMessage(
            "Θα ανακατευθυνθείτε στο Github")
      };
}
